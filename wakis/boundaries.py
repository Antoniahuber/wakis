...
class BCsMixin:
    ...
    def _initialize_CPML_matrices(self):
        ...
        if self.bc_low[0].lower() == "cpml":
            ...
            self.pml_b_E_x_low = self.pml_b_E[:self.n_pml, :, :, 'x'].copy()
            self.pml_b_H_x_low = self.pml_b_H[:self.n_pml, :, :, 'x'].copy()
            self.pml_c_E_x_low = self.pml_c_E[:self.n_pml, :, :, 'x'].copy()
            self.pml_c_H_x_low = self.pml_c_H[:self.n_pml, :, :, 'x'].copy()
        if self.bc_low[1].lower() == "cpml":
            ...
            self.pml_c_E_y_low = self.pml_c_E[:, :self.n_pml, :, 'y'].copy()
            self.pml_c_H_y_low = self.pml_c_H[:, :self.n_pml, :, 'y'].copy()
            self.pml_b_E_y_low = self.pml_b_E[:, :self.n_pml, :, 'y'].copy()
            self.pml_b_H_y_low = self.pml_b_H[:, :self.n_pml, :, 'y'].copy()
        if self.bc_low[2].lower() == "cpml":
            ...
            self.pml_c_E_z_low = self.pml_c_E[:, :, :self.n_pml, 'z'].copy()
            self.pml_c_H_z_low = self.pml_c_H[:, :, :self.n_pml, 'z'].copy()
            self.pml_b_E_z_low = self.pml_b_E[:, :, :self.n_pml, 'z'].copy()
            self.pml_b_H_z_low = self.pml_b_H[:, :, :self.n_pml, 'z'].copy()
        if self.bc_high[0].lower() == "cpml":
            ...
            self.pml_c_E_x_high = self.pml_c_E[-self.n_pml:, :, :, 'x'].copy()
            self.pml_c_H_x_high = self.pml_c_H[-self.n_pml:, :, :, 'x'].copy()
            self.pml_b_E_x_high = self.pml_b_E[-self.n_pml:, :, :, 'x'].copy()
            self.pml_b_H_x_high = self.pml_b_H[-self.n_pml:, :, :, 'x'].copy()
        if self.bc_high[1].lower() == "cpml":
            ...
            self.pml_c_E_y_high = self.pml_c_E[:, -self.n_pml:, :, 'y'].copy()
            self.pml_c_H_y_high = self.pml_c_H[:, -self.n_pml:, :, 'y'].copy()
            self.pml_b_E_y_high = self.pml_b_E[:, -self.n_pml:, :, 'y'].copy()
            self.pml_b_H_y_high = self.pml_b_H[:, -self.n_pml:, :, 'y'].copy()
        if self.bc_high[2].lower() == "cpml":
            ...
            self.pml_c_E_z_high = self.pml_c_E[:, :, -self.n_pml:, 'z'].copy()
            self.pml_c_H_z_high = self.pml_c_H[:, :, -self.n_pml:, 'z'].copy()
            self.pml_b_E_z_high = self.pml_b_E[:, :, -self.n_pml:, 'z'].copy()
            self.pml_b_H_z_high = self.pml_b_H[:, :, -self.n_pml:, 'z'].copy()
