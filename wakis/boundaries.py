...
class BCsMixin:
    ...
    def _initialize_CPML_matrices(self):
        ...
        if self.bc_low[1].lower() == "cpml":
            self.psiHa_x_low = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiHb_z_low = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiEa_x_low = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiEb_z_low = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
        ...
        if self.bc_low[2].lower() == "cpml":
            self.psiHa_y_low = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiHb_x_low = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiEa_y_low = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiEb_x_low = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
        ...
        if self.bc_high[1].lower() == "cpml":
            self.psiHa_x_high = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiHb_z_high = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiEa_x_high = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiEb_z_high = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
        ...
        if self.bc_high[2].lower() == "cpml":
            self.psiHa_y_high = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiHb_x_high = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiEa_y_high = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
            self.psiEb_x_high = np.zeros((self.n_pml * self.Ny * self.Nz), dtype=self.dtype)
